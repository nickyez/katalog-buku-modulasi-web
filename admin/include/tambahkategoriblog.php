            ...
            <section class="content">
                ...
                <div class="card card-info">
                    ...
                    <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-tambah-kategori-blog.php">
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="kategoriblog" class="col-sm-3 col-form-label">Kategori Blog</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="kategori_blog" id="kategoriblog"
                                        value="">
                                </div>
                            </div>
                        </div>
