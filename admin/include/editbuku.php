                            ...
                            <select class="form-control" id="kategori" name="kategori_buku">
                                ...
                                <?php 
                                            ...
                                            while($data_k = mysqli_fetch_row($query_k)){
                                                ...
                                                $kat = $data_k[1];
                                            ?>
                                <option value="<?php echo $id_kat;?>" <?php if($id_kat==$id_kategori_buku){?> selected
                                    <?php }?>><?php echo $kat;?></option>
                                <?php }?>
                            ...
                            <select class="form-control" id="kategori" name="penerbit">
                                ...
                                <?php 
                                            ...
                                            while($data_t = mysqli_fetch_row($query_t)){
                                                ...
                                                $terbit = $data_t[1];
                                            ?>
                                <option value="<?php echo $id_terbit;?>" <?php if($id_terbit==$id_penerbit){ ?> selected
                                    <?php } ?>><?php echo $terbit;?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
